        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-8">
              ...
              <h2 className="text-2xl font-display font-bold mt-2">{product.name}</h2>
              ...
              <div className="flex items-center gap-3 mt-5">
                ...
                <span className="text-muted line-through text-sm">₹{original.toLocaleString("en-IN")}</span>
                <span className="text-success text-sm font-semibold">{discount}% off</span>
              </div>
              ...
              <div className="flex items-center gap-3 mt-6">
                <div className="flex items-center bg-surface rounded-full px-2 py-2 border border-border">
                  <button onClick={() => setQty((q) => Math.max(1, q - 1))} className="p-2 hover:text-primary transition-colors">
                    <Minus size={14} />
                  </button>
                  <span className="w-7 text-center text-sm font-medium">{qty}</span>
                  <button onClick={() => setQty((q) => q + 1)} className="p-2 hover:text-primary transition-colors">
                    <Plus size={14} />
                  </button>
                </div>
                <button
                ...
                >
                  <Heart size={17} className={wishlisted ? "fill-primary text-primary" : "text-ink"} />
                </button>
              </div>
